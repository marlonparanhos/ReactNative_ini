...
// 'export' sem 'default' exige nome e deve ser armazenada numa variável
...
// outra possibilidade de export sem precisar utilizar 'export' direto no cabeçalho da função
